...
_G.packer_plugins = {
  ...
  ["hop.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/lqf/.local/share/nvim/site/pack/packer/opt/hop.nvim",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-matchup', 'hop.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
