...
nnoremap('<leader>fp', [[:<C-u>CocCommand fzf-preview.FromResources project_mru git --resume<CR>]], opt)
...
nnoremap('<leader>fgr', [[:<C-u>CocCommand fzf-preview.ProjectGrep<Space>]], opt)
